...
export const Header: React.FC<HeaderProps> = ({ onAddDesign }) => {
      ...
      <div className="ml-auto flex items-center gap-3">
        ...
        {avatarError ? (
          ...
          <img 
            ...
            className="w-8 h-8 rounded-full shadow-sm object-cover border-2 border-white cursor-pointer hover:ring-2 hover:ring-fracht-blue/50 transition-all"
